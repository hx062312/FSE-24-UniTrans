document.addEventListener('DOMContentLoaded', function() {
    ...
    // reload 按钮事件绑定
    modalReloadBtn.onclick = function() {translateBtn.onclick();};
    translationReloadBtn.onclick = function() {modalNextStepBtn.onclick();};
    repairReloadBtn.onclick = function() {nextStepBtn.onclick();};
    ...
    nextStepBtn.onclick = async function() {
        ...
        try {
            ...
            if (repairResult.success) {
                ...
                const repairTestCasesSection = document.querySelector('#repairModal .display-section:nth-of-type(2) #testCases');
