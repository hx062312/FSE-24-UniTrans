...
if __name__ == "__main__":
    ...
    test_case_file = f"./cleaned_data/{model}/test_cases/test_cases_{src_lang}.jsonl"
    if dst_lang == "python":
        fetch_exe_ret_py(target_file, out_file, test_case_file, test_case_num, timeout=30)
    elif dst_lang == "java":
        fetch_exe_ret_ja(target_file, out_file, test_case_file, test_case_num, timeout=30)
    elif dst_lang == "cpp":
        fetch_exe_ret_cp(target_file, out_file, test_case_file, test_case_num, timeout=30)
