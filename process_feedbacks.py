                            ...
                            new_item_lst.append(
                                {
                                    ...
                                    "err_type": "Compilation Error",
                                    "err_msg": err_msg,
                                    "err_line": code_lines[err_line_no].strip(),
                                    "err_line_no": err_line_no,
                                    "marked_code": "\n".join(code_lines),
                                }
                            )
            ...
            for idx, item in enumerate(item_lst):
                ...
                if item[1] == "OK":
                    ...
                    if "Compilation Error" in item[1]:
                        ...
                        msg_head = (
                            item[1]
                            .split("Stack trace (most recent call last):")[0]
                        ...
                        err_msg = []
                        if (
                            "stack smashing detected" in msg_head
                            or "double free or corruption (out)" in msg_head
                        ):
                        ...
                        pattern = re.compile(
                            r"Expected Output:.*?,Actual Output:.*?,Expected output and actual output are not equal!"
                        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--test_case_num", type=int, help="num of test cases", default=3
    )
